// =========================================================
// ======== Contenido NUEVO para el archivo server.js ========
// =========================================================
...
let estadoActualElectrodomesticos = [
  { id: "NEV-001", nombre: "Refrigeradora", consumo_watts: 160, timestamp: new Date().toISOString() },
  { id: "TV-LIV-001", nombre: "Televisor (Living)", consumo_watts: 85, timestamp: new Date().toISOString() },
  { id: "MICRO-01", nombre: "Microondas", consumo_watts: 0, timestamp: new Date().toISOString() }, // Empieza apagado
  { id: "LAP-WRK-01", nombre: "Laptop (Cargando)", consumo_watts: 65, timestamp: new Date().toISOString() },
  { id: "AC-DORM-01", nombre: "Aire Acondicionado", consumo_watts: 1500, timestamp: new Date().toISOString() }
];
...
setInterval(() => {
  ...
  estadoActualElectrodomesticos = estadoActualElectrodomesticos.map(item => {
    ...
    return {
      ...item, // Mantiene el id y el nombre
